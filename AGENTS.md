...
Repository Map
- onleiharr/cli.py: argparse CLI, logging, main loop, notifications, auto-lend/reserve logic.
...
- tests/: pytest coverage for config, watcher behavior, and vendored API-facing behavior.
...
- Run watcher: `onleiharr` or `onleiharr -c path/to/onleiharr.toml`.
